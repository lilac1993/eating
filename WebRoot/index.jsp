...
<html>
  ...
  <body>
    ...
    <div  class="k" >
    	...
    	<form action="/eatingserver/servlet/ser?action=login"  method="post">
    		<BR/><BR/><BR/>
    		...
    		<input type="submit" value="注册" class="button" style="display: block;border:none;background-image:url(photo/zhuce.png);background-size:100% 100%;height: 25px;text-indent: -9999em;width:60px;float:right;margin-right:35px;"/>
