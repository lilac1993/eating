...
public class jchart extends HttpServlet {
	...
	@SuppressWarnings("deprecation")
		...
		savepath = getServletContext().getRealPath("/tjimages/");
      ...
      //frame.setLayout(new GridLayout(2,2,10,10));  
        frame.add(new jchart().getChartPanel());    //添加折线图  
      
        frame.setBounds(50, 50, 800, 300);  
        //frame.setVisible(true);
//        savepath = getServletContext().getRealPath("/tjimages/");
      System.out.printf(savepath);
        try { 
        	 ChartUtilities.saveChartAsPNG(new File(savepath+"/tj3.png"),jfreechart , 800, 300); 
    	  } catch (IOException e) { 
...
//    	        savepath = getServletContext().getRealPath("/tjimages/");
    	      System.out.printf(savepath);
    	        try { 
    	        	 ChartUtilities.saveChartAsPNG(new File(".\\tjimages\\tj.png"),jfreechart , 800, 300); 
    	    	  } catch (IOException e) { 
    	    	  // TODO Auto-generated catch block 
    	    		 e.printStackTrace(); 
    	    	  } 
